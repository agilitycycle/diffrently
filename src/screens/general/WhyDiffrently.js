	...
	return (<>
      ...
      <div className="flex items-center justify-center h-full">
        <div className="h-full w-full sm:w-7/12">
          <div className="p-5">
            <div className="flex flex-col md:flex-row justify-between mt-6 text-4xl text-secondary font-sans font-thin">
            ...
            <p className="text-secondary theme-dark:text-gray-400 mb-4 leading-relaxed">
            ...
            <div className="flex flex-col mt-9 mb-9 text-3xl text-secondary font-sans font-thin">
            ...
            <p className="text-secondary theme-dark:text-gray-400 leading-relaxed">
            ...
            <p className="text-secondary theme-dark:text-gray-400 leading-loose">
